...
struct Colors {
    static let button: UIColor = UIColor(named: "buttonColor") ?? .systemBlue
    static let wineCategory: UIColor = UIColor(named: "wineCategoryColor") ?? .black
    static let averageRate: UIColor = UIColor(named: "averageRateColor") ?? .black
    ...
    static let errorPopUp: UIColor = UIColor(named: "errorPopUp") ?? .systemBlue
}
